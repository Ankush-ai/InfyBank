...
public class CustomerAPI {
	...
	public ResponseEntity<CustomerDTO> getCustomer( @Min (value=1, message="customer id should be between 1 and 100") @Max(value=1,message="customer id should be between 1 and 100")
